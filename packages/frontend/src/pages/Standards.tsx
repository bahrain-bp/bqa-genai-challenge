    ...
    <DefaultLayout>
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
          ...
          <div className="circle-background">
            ...
            <a href={`PredefinedTemplate/Standard1`} className="link-unstyled">
   
    <h6 className="m-b-20">Standard 1</h6></a>
      </div>
        </div>
        <div className="rounded-xl border border-stroke bg-white py-6 px-7.5 shadow-default dark:border-strokedark dark:bg-boxdark">
          <div className="scard-block">
          <div className="circle-background">
            ...
            <a href={`PredefinedTemplate/Standard2`} className="link-unstyled">
   
    <h6 className="m-b-20">Standard 2</h6></a>
      </div>
        </div>
        <div className="rounded-xl border border-stroke bg-white py-6 px-7.5 shadow-default dark:border-strokedark dark:bg-boxdark">
          <div className="scard-block">
          <div className="circle-background">
            ...
            <a href={`PredefinedTemplate/Standard3`} className="link-unstyled">
   
    <h6 className="m-b-20">Standard 3</h6></a>
      </div>
        </div>
        <div className="rounded-xl border border-stroke bg-white py-6 px-7.5 shadow-default dark:border-strokedark dark:bg-boxdark">
          <div className="scard-block">
          <div className="circle-background">
            ...
            <a href={`PredefinedTemplate/Standard4`} className="link-unstyled">
   
    <h6 className="m-b-20">Standard 4</h6></a>
      </div>
        </div>
